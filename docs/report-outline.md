...
| Male digital substitute | 使用男性 3D 卡通半身数字替身 | 立体头部、发型体块、凸起五官、肩颈服装和隐私徽标共同遮挡真实脸 |
| Female digital substitute | 使用女性 3D 卡通半身数字替身 | 立体头部、长发体块、凸起五官、肩颈服装和隐私徽标共同遮挡真实脸 |
...
- 当前数字替身为程序化 3D 卡通半身 avatar，已具备头部体积、发型、五官和服装层次，但仍可继续增强表情、骨骼动画和自定义外观。
