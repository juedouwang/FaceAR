...
| Male digital substitute | 使用男性高质感 3D 卡通半身数字替身 | 立体头部、发型尖峰、绿框眼镜、雀斑、凸起五官、肩颈服装和隐私徽标共同遮挡真实脸 |
| Female digital substitute | 使用女性高质感 3D 卡通半身数字替身 | 立体头部、头巾/发饰、长发体块、眼线、耳饰、雀斑/美人痣、肩颈服装和隐私徽标共同遮挡真实脸 |
...
- 当前数字替身为程序化高质感 3D 卡通半身 avatar，已具备头部体积、发型、配饰、五官和服装层次，但仍可继续增强表情、骨骼动画和自定义外观。
