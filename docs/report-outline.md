...
| Male digital substitute | 使用男性卡通数字替身 | 头部、发型、五官、肩颈和隐私徽标共同遮挡真实脸 |
| Female digital substitute | 使用女性卡通数字替身 | 头部、长发轮廓、五官、肩颈和隐私徽标共同遮挡真实脸 |
...
- 当前数字替身为程序化卡通数字人，已比基础几何头像更完整，但仍可继续增强表情、发型和自定义外观。
